...
//                        addTextView(null, currentX, currentY, "", android.R.color.black, 0, 0);
//                        showDialog("", true);
     ...
     * 添加一个TextView到界面上
     */
    public void addTextView(TextView tv, float x, float y,
                            String content, int color, float mtextSize, float rotate,int flag) {
        if (tv == null) {
            if (mtextSize == 0) {
...
//            textView.setText(content);
            ...
            if (flag == 1){
                textView.setCompoundDrawablesWithIntrinsicBounds
                        (null,getResources().getDrawable(R.drawable.eyebrow1),null,null);
            }else if (flag == 2){
                textView.setCompoundDrawablesWithIntrinsicBounds
                        (null,getResources().getDrawable(R.drawable.eyebrow2),null,null);
            }
