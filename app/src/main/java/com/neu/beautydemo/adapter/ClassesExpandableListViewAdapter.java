...
public class ClassesExpandableListViewAdapter extends BaseExpandableListAdapter {
    ...
    public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        return getSecondView(classes.get(groupPosition).name);
    }
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        return getThirdView(classes.get(groupPosition).students.get(childPosition));
    }
     ...
     * @return
     */
    private TextView getSecondView(String string) {
        ...
        textView.setTextColor(Color.parseColor("#FF202D76"));
        //这里是子expandablelistview
        return textView;
    }
    private TextView getThirdView(String string) {
