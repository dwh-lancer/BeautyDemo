...
//        init(context);
    ...
    private void init(Context context) {
        ...
        Point screenPoint = new Point(width,height);
        //初始化左上角的点
        mLTPoint = new Point(screenPoint.x / 6 * 2, screenPoint.y / 6);
        //初始化右上角的点
        mRTPoint = new Point(screenPoint.x / 6 * 4, screenPoint.y / 6);
        //初始化左下角的点
        mLBPoint = new Point(screenPoint.x / 6 * 2, screenPoint.y / 6 * 5);
        //初始化右下角的点
        mRBPoint = new Point(screenPoint.x / 6 * 4, screenPoint.y / 6 * 5);
